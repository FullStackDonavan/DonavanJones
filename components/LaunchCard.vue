  ...
  <div>
    <div class="container mx-auto">
      <div style="cursor: auto;">
          <div class="rounded-md shadow text-white bg-gray-800">
            <div class="flex items-center justify-between p-3" style="cursor: auto;">
              <div class="flex items-center space-x-2" style="cursor: auto;">
                <img src="~assets/images/epoxyfloorsolutions-logo.jpg" alt="" class="object-cover object-center w-8 h-8 rounded-full shadow-sm bg-coolGray-500 border-coolGray-700" style="cursor: auto;">
                <div class="-space-y-1 flex" style="cursor: auto;">
                  <h2 class="text-sm font-semibold leading-none" style="cursor: auto;">{{ title }}</h2>
                  <span class="inline-block text-xs leading-none text-coolGray-400" style="cursor: auto;">{{ city }}</span>
                </div>
              </div>
