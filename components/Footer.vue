  ...
  <footer class="p-4 bg-gray-900 sm:p-6">
      <div class="mx-auto max-w-screen-xl">
          <div class="md:flex md:justify-between">
              <div class="mb-6 md:mb-0">
                  <a href="https://flowbite.com" class="flex items-center">
                    <img src="~/assets/images/logo.png" class="h-14 mr-2" alt="DJ Web Media Logo" />
                      <span class="self-center text-2xl font-semibold whitespace-nowrap text-white">DJ Web Media</span>
                  </a>
              </div>
          ...
          <div class="sm:flex sm:items-center sm:justify-between">
              <span class="text-sm text-gray-400 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com" class="hover:underline">DJ Web Media</a>. All Rights Reserved.
              </span>
