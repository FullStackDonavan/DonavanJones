    ...
    >
      <div
        class="absolute inset-0
               bg-gradient-to-r from-emerald-200/20 via-amber-200/10 to-sky-200/10
               dark:from-emerald-500/5 dark:via-amber-500/5 dark:to-sky-500/5"
      />
      ...
      <div class="relative p-8 lg:p-10">
        ...
        <div class="grid lg:grid-cols-[1.5fr_1fr] gap-10 items-start">
          ...
          <div>
            ...
            <h2
              class="mt-4 text-4xl md:text-5xl lg:text-6xl
                     font-bold leading-tight text-slate-900 dark:text-slate-100"
            >
              Match AI Spend
              <span class="block text-emerald-400">to Actual Usage</span>
            </h2>

            <p class="mt-6 max-w-2xl text-lg text-slate-700 dark:text-slate-300 leading-relaxed">
              Real cost breakdowns, hardware ROI math, and the break-even framework for
              deciding between hosted APIs and local infrastructure.
            </p>
            ...
            <div class="mt-10">
              <div class="rounded-2xl border border-slate-200 dark:border-slate-700/50 bg-slate-50 dark:bg-slate-900/60 overflow-hidden">
                <div class="px-5 py-3.5 border-b border-slate-200 dark:border-slate-800 flex items-center gap-2">
                  ...
                  <span class="text-[10px] text-slate-400 dark:text-slate-500 ml-1">cost.model</span>
                </div>

                <div class="px-5 py-4">
                  <p class="text-[10px] uppercase tracking-widest text-emerald-500 font-semibold mb-4">Cost Decision Flow</p>
                  <div class="flex flex-wrap items-center gap-2 lg:gap-3">
                    <div class="flow-node">
                      <Icon name="mdi:chart-line" class="text-sky-400 text-xl" />
                      <span>Usage Volume</span>
                    </div>
                    <Icon name="mdi:chevron-right" class="text-slate-400 dark:text-slate-600 hidden sm:block" />
                    <div class="flow-node">
                      <Icon name="mdi:calculator" class="text-amber-400 text-xl" />
                      <span>Break-Even Math</span>
                    </div>
                    <Icon name="mdi:chevron-right" class="text-slate-400 dark:text-slate-600 hidden sm:block" />
                    <div class="flow-node">
                      <Icon name="mdi:call-split" class="text-purple-400 text-xl" />
                      <span>Hybrid Routing</span>
                    </div>
                    <Icon name="mdi:chevron-right" class="text-slate-400 dark:text-slate-600 hidden sm:block" />
                    <div class="flow-node">
                      <Icon name="mdi:cash-check" class="text-emerald-400 text-xl" />
                  ...
                  <p class="mt-4 pt-4 border-t border-slate-200 dark:border-slate-800 text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed">
                    Usage volume feeds a break-even calculation, which decides how much
                    traffic routes to local infrastructure versus a hosted API.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div class="rounded-2xl border border-slate-200 dark:border-slate-700/50 bg-slate-50 dark:bg-slate-900/60 overflow-hidden transition-all duration-200 hover:border-sky-500/40 hover:shadow-lg hover:shadow-sky-500/5 group/sky">
              ...
              <div class="px-4 py-3">
                <p class="text-[10px] uppercase tracking-widest text-sky-500 font-semibold mb-2 transition-colors duration-200 group-hover/sky:text-sky-600 dark:group-hover/sky:text-sky-400">API Costs</p>
                <p class="text-[11px] text-slate-500 dark:text-slate-400 mb-3">Per-token pricing, caching, and real spend drivers</p>
                <div class="flex flex-wrap gap-1.5">
                  <span v-for="t in ['Claude API', 'OpenAI API', 'Caching']" :key="t"
            ...
            <div class="rounded-2xl border border-slate-200 dark:border-slate-700/50 bg-slate-50 dark:bg-slate-900/60 overflow-hidden transition-all duration-200 hover:border-amber-500/40 hover:shadow-lg hover:shadow-amber-500/5 group/amber">
              <div class="px-4 py-3 border-b border-slate-200 dark:border-slate-800 flex items-center gap-2">
                ...
                <span class="text-[10px] text-slate-400 dark:text-slate-500 ml-1">hardware.config</span>
              </div>
              <div class="px-4 py-3">
                <p class="text-[10px] uppercase tracking-widest text-amber-500 font-semibold mb-2 transition-colors duration-200 group-hover/amber:text-amber-600 dark:group-hover/amber:text-amber-400">Hardware ROI</p>
                <p class="text-[11px] text-slate-500 dark:text-slate-400 mb-3">Amortization, useful life, break-even months</p>
                <div class="flex flex-wrap gap-1.5">
                  <span v-for="t in ['Amortization', 'Break-Even', 'Utilization']" :key="t"
            ...
            <div class="rounded-2xl border border-slate-200 dark:border-slate-700/50 bg-slate-50 dark:bg-slate-900/60 overflow-hidden transition-all duration-200 hover:border-purple-500/40 hover:shadow-lg hover:shadow-purple-500/5 group/purple">
              <div class="px-4 py-3 border-b border-slate-200 dark:border-slate-800 flex items-center gap-2">
                ...
                <span class="text-[10px] text-slate-400 dark:text-slate-500 ml-1">electricity.config</span>
              </div>
              <div class="px-4 py-3">
                <p class="text-[10px] uppercase tracking-widest text-purple-500 font-semibold mb-2 transition-colors duration-200 group-hover/purple:text-purple-600 dark:group-hover/purple:text-purple-400">Electricity</p>
                <p class="text-[11px] text-slate-500 dark:text-slate-400 mb-3">Marginal cost per request, honestly measured</p>
                <div class="flex flex-wrap gap-1.5">
                  <span v-for="t in ['kWh Pricing', 'GPU Draw', 'Marginal Cost']" :key="t"
            ...
            <div class="rounded-2xl border border-slate-200 dark:border-slate-700/50 bg-slate-50 dark:bg-slate-900/60 overflow-hidden transition-all duration-200 hover:border-emerald-500/40 hover:shadow-lg hover:shadow-emerald-500/5 group/emerald">
              <div class="px-4 py-3 border-b border-slate-200 dark:border-slate-800 flex items-center gap-2">
                ...
                <span class="text-[10px] text-slate-400 dark:text-slate-500 ml-1">routing.config</span>
              </div>
              <div class="px-4 py-3">
                <p class="text-[10px] uppercase tracking-widest text-emerald-500 font-semibold mb-2 transition-colors duration-200 group-hover/emerald:text-emerald-600 dark:group-hover/emerald:text-emerald-400">Hybrid Routing</p>
                <p class="text-[11px] text-slate-500 dark:text-slate-400 mb-3">Local for volume, hosted for the hardest tasks</p>
                <div class="flex flex-wrap gap-1.5">
                  <span v-for="t in ['Classification', 'Escalation', 'Cost-Aware']" :key="t"
        ...
        <div class="mt-10">
          <div class="rounded-2xl border border-slate-200 dark:border-slate-700/50 bg-slate-50 dark:bg-slate-900/60 overflow-hidden">
            <div class="px-5 py-3.5 border-b border-slate-200 dark:border-slate-800 flex items-center gap-2">
              ...
              <span class="text-[10px] text-slate-400 dark:text-slate-500 ml-1">cost.stack</span>
            </div>
            <div class="px-5 py-4">
              <p class="text-[10px] uppercase tracking-widest text-emerald-500 font-semibold mb-3">Cost Analysis Toolkit</p>
              <div class="flex flex-wrap gap-1.5">
                <span v-for="t in ['Claude API', 'OpenAI API', 'RTX 3090', 'Jetson Orin', 'kWh Modeling', 'ROI Frameworks']" :key="t"
...
<style scoped>
.flow-node {
  @apply flex items-center gap-1.5 px-3 py-2 rounded-lg text-[11px] font-medium
