...
useSeoMeta({
  title: 'Insights — Donavan Jones',
  description: 'Practical articles for Lakeland and Central Florida business owners — AI automation, hiring software developers, custom business software, and local tech opportunities.',
  ogTitle: 'Insights — Donavan Jones',
  ogDescription: 'Practical articles for Lakeland and Central Florida businesses on AI automation, custom software, and hiring developers.',
  ogType: 'website',
  ogImage: `${_SITE}/img/logo.png`,
  ogUrl: `${_SITE}/insights/overview`,
  twitterCard: 'summary_large_image',
  twitterTitle: 'Insights — Donavan Jones',
  twitterDescription: 'Practical articles for Lakeland and Central Florida business owners on AI, custom software, and hiring developers.',
  canonical: `${_SITE}/insights/overview`,
})
...
const { data: articles, refresh } = await useAsyncData("insights", () =>
  queryContent("/insights")
    .where({ draft: { $ne: true } })
    .sort({ date: -1 })
    ...
    <div class="w-full">
      ...
      <div class="bg-white dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800">
        <div class="max-w-4xl mx-auto px-6 py-20 sm:py-28 text-center">
          ...
          >
            <Icon name="mdi:lightbulb-outline" class="text-sm" />
          ...
          <p class="mt-5 text-lg text-slate-500 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed">
            Practical articles for Lakeland and Central Florida business owners — AI automation,
            custom software, and what to look for when hiring a developer.
          </p>
          ...
          <div class="mt-8 flex flex-wrap justify-center gap-6 text-sm text-slate-500 dark:text-slate-400">
            ...
            <span class="flex items-center gap-1.5">
              <Icon name="mdi:map-marker-outline" class="text-sky-400" />
              Lakeland, FL &amp; Central Florida
            </span>
            <span class="flex items-center gap-1.5">
